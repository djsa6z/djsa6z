local Window = Library.CreateLib("Jujutsu Chronicles Script|Viet Nam Is Number One ")
...
local Tab3 = Window:NewTab("Vessel")
local Section = Tab3:NewSection("Vessel")

Section:NewButton("Sukuna Vessel!!!", "ButtonInfo", function()
    local player = game.Players.LocalPlayer
local character = player.Character or player.CharacterAdded:Wait()
local hasVesselFinger = character:WaitForChild("Has_VesselFinger")
hasVesselFinger.Value = "Yes"

Section:NewButton("Skill Z", "ButtonInfo", function()
    local player = game.Players.LocalPlayer

local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("Z")
newProperty.Value = "VesselSwap"

end)

Section:NewButton("Skill X", "ButtonInfo", function()
    local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("X")
newProperty.Value = "SkullSmash"

end)

Section:NewButton("Skill C", "ButtonInfo", function()
    local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("C")
newProperty.Value = "MurderousCleave"

end)

Section:NewButton("Skill V", "ButtonInfo", function()
    local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("V")
newProperty.Value = "SukunaHellfire"

end)

Section:NewButton("Skill B", "ButtonInfo", function()
    local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("B")
newProperty.Value = "SpiderWeb"

end)


Section:NewButton("Skill N", "ButtonInfo", function()
    local character = player.Character or player.CharacterAdded:Wait()
local newProperty = character:WaitForChild("N")
newProperty.Value = "MalevonentShrine"
